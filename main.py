...
def main():
    ...
    st.set_page_config(page_title='TasteTrail', page_icon="https://github.com/hanaz5/TasteTrail/blob/main/images/icon.png")
    with open('styles.css') as f:
        st.markdown(f'<style>{f.read()}</style>', unsafe_allow_html=True)

    LOGO_IMAGE_URL = "https://github.com/hanaz5/TasteTrail/blob/main/images/logo.png"
